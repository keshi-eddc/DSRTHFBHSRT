...
import com.eddc.johnsoncrawler.utils.http.exception.MethodNotSupportException;
import com.eddc.johnsoncrawler.utils.http.request.BaseEntityRequest;
...
public class HttpClientUtil {
    ...
    private static final int MAX_CONNECT_TIMEOUT = 100 * 1000;
    private static final int MAX_SOCKET_TIMEOUT = 100 * 1000;
    private static final int MAX_CONNECT_REQUEST_TIMEOUT = 100 * 1000;
